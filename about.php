          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card-header py-3 d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Tentang Kami kelompok 5 dari Basis Data Kelas D 2025 ITG</h6>
                ...
                <div class="card-body">
                  ...
                  <li>MOHAMAD KAYLA ANASA (2306166): Support</li>
                  </ul>
                </div>
              </div>
            </div>
